...
<script type="text/javascript" src="./js/script_produits.js"> </script>
...
<div class="w3-top">
    <div class="w3-bar w3-red w3-card w3-left-align w3-large">
        ...
        <a href="Panier.php" id="cart" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Mon panier</a>
    </div>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>";
        echo '<td><a href="FicheProduit.php?produit='.$row["id"] .' "><img id="produit_icn" src="data:image/png;base64,' . base64_encode($row["icone"]) . '" /></a></td>';
        echo"</tr>";
        ...
        if ($rresult->num_rows > 0) {
            ...
            while ($rrow = $rresult->fetch_assoc()) {
                ...
                echo "<tr>";
                if($rrow["quantite"] <= 0){
                    echo "<td><input id=\"boutton_produit\" type=\"submit\" value=\"Ajouter au panier\" name=\"" . $rrow["id_produit"] . "\" disabled/></td>";
                }else {
                    echo "<td><input id=\"boutton_produit\" type=\"submit\" value=\"Ajouter au panier\" name=\"" . $rrow["id_produit"] . "\" /></td>";
                }
