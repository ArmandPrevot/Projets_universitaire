...
<div id="form">
	<form method="post"  class="formulaire">
        ...
        <p><input type="text" name="email" id="mail"></p>
        <p>Entrez votre mot de passe : </p>
        <p><input type="password" id="mdp" name="mdp">
        </p><!--<label>Se souvenir de moi : </label>
        <input type="checkbox" name="souvenir">-->
        <p><button type="submit" name="connection">Connexion</button></p>
    </form>
    <p><a href="">Mot de passe oublié</a></p>
    <p><label>Pas de compte ? </label><input type="button" onclick="document.location.href='Inscription.php';" value="S'inscrire"></p>
</div>
<?php
	$bdd->close();
?>
