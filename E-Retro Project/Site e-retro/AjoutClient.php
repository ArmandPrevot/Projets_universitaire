    ...
    $sqlSend = false;
                ...
                if( isset($_POST["email"]) === true && preg_match($pattern, $_POST["email"]) !== 1){
                    ...
                    if(isset($_POST["scales"]) === true){
                        $sql = "INSERT INTO client VALUES ('0', '". $_POST["nom"] . "', '". $_POST["prenom"] . "', '" . $_POST["email"] . "', '". $_POST["mdp"] . "', '" . $_POST["addr"] . "' , '1' )";

                    }else{
                        $sql = "INSERT INTO client VALUES ('0', '". $_POST["nom"] . "', '". $_POST["prenom"] . "', '" . $_POST["email"] . "', '". $_POST["mdp"] . "', '" . $_POST["addr"] . "' , '0' )";
                    }

                    if($canBeRegistered === true && $bdd->query($sql) ) {
                        $sqlSend = true;
                        echo"<p class=\"ok\"> Nouveau client créer ! </p>";
                ...
                if($sqlSend === false) {
                    ...
                    echo "<label>Mot de passe: <input type=\"text\" name=\"mdp\"/></label><br/>";
